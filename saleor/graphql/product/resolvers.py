...
def resolve_attributes(
    info, qs=None, in_category=None, in_collection=None, query=None, **_kwargs
):
...
def resolve_categories(info, query, level=None, **_kwargs):
...
def resolve_collections(info, query, **_kwargs):
...
def resolve_products(info, stock_availability=None, query=None, **_kwargs):
...
def resolve_product_types(info, query, **_kwargs):
