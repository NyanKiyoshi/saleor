...
class AttributeSortField(graphene.Enum):
    NAME = ["name", "pk"]
    SLUG = "slug"
    VALUE_REQUIRED = ["value_required", "name", "pk"]
    IS_VARIANT_ONLY = ["is_variant_only", "name", "pk"]
    VISIBLE_IN_STOREFRONT = ["visible_in_storefront", "name", "pk"]
    FILTERABLE_IN_STOREFRONT = ["filterable_in_storefront", "name", "pk"]
    FILTERABLE_IN_DASHBOARD = ["filterable_in_dashboard", "name", "pk"]
...
class CategorySortField(graphene.Enum):
    NAME = ["name", "pk"]
    PRODUCT_COUNT = ["product_count", "name", "pk"]
    SUBCATEGORY_COUNT = ["subcategory_count", "name", "pk"]
...
class ProductOrderField(graphene.Enum):
    NAME = ["name", "pk"]
    PRICE = ["price_amount", "name", "pk"]
    MINIMAL_PRICE = ["minimal_variant_price_amount", "name", "pk"]
    DATE = ["updated_at", "name", "pk"]
    TYPE = ["product_type__name", "name", "pk"]
    PUBLISHED = ["is_published", "name", "pk"]
...
class ProductTypeSortField(graphene.Enum):
    NAME = ["name", "pk"]
    DIGITAL = ["is_digital", "name", "pk"]
    SHIPPING_REQUIRED = ["is_shipping_required", "name", "pk"]
